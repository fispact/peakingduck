...
from PEAKINGDUCK.core import IPeakFinder, PeakInfo, NumericalData, window
...
class WindowPeakFinder(IPeakFinder):
    ...
    def find(self, data, *args, **kwargs):
        ...
        for i, value in enumerate(data):
            ...
            values = window(data, i, nouter=self.nouter, ninner=self.ninner, includeindex=self.include_point)
